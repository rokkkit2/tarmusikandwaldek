...
async function main(){
    ...
    '--disable-setuid-sandbox',
      ...
      await page.$eval('input[id=upass]', el => el.value = 'kubatoidiota321');
...
async function discord(){
    try{
        ...
        await page.screenshot({path: `ekwipunekdwaldek.png`, fullPage: true});
        const well = bot.channels.get("683374637819756623")
        await well.send({files: [`./ekwipunekdwaldek.png`]}).then(msg => (msg.delete(120000)));
        const path = `./ekwipunekdwaldek.png`
